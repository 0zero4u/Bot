...
// Version 6.0.4 - Added explicit BBO logging for diagnostics.
    ...
    constructor(apiKey, apiSecret, baseUrl) {
        ...
        this.axios = axios.create({
            ...
            headers: {
                ...
                'User-Agent': 'Bybit-Delta-Trading-Bot/6.0.4'
            }
        });
    }
    ...
    connectToDeltaWs() {
        ...
        ws.on('message', (data) => {
            ...
            if (msg.type === 'auth' && msg.success) {
                ...
                logger.info('L1 BBO Received:', {
                    bid_price: msg.best_bid_price,
                    bid_size: msg.best_bid_size,
                    ask_price: msg.best_ask_price,
                    ask_size: msg.best_ask_size,
                });
