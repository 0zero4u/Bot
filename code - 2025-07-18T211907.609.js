// trader.js
// Final, Corrected, and State-Aware Delta Exchange Trading Bot
// Version 5.0.2 - With Correct Leverage Endpoint
...
class DeltaExchangeClient {
  constructor(apiKey, apiSecret, baseUrl) {
    ...
    this.axios = axios.create({ baseURL: baseUrl, timeout: 10000, headers: { 'Content-Type': 'application/json', 'User-Agent': 'Bybit-Delta-Trading-Bot/5.0.2' } });
  }
