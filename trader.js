// trader.js
// Version 11.5.2 - FIXED race condition by adding a finally block to reset state.
...
class TradingBot {
    ...
    async start() {
        this.logger.info(`--- Bot Initializing (v11.5.2) ---`);
    ...
    // MODIFIED: Added a finally block to ensure isOrderInProgress is always reset.
    async placeStopLossOrder(mainOrder) {
        ...
        if (!slPrice) {
            ...
            this.isOrderInProgress = false; // Reset flag on immediate failure
            return;
        }
