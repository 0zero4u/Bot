// trader.js
// Version 10.2.2 - Corrected bracket order placement logic
...
class TradingBot {
    ...
    async start() {
        this.logger.info(`--- Bot Initializing (v10.2.2) ---`);
    ...
    async placeBracketOrders(mainOrder) {
        ...
        const tpOrder = {
            ...
            reduce_only: true,
            stop_order_type: 'take_profit_order', // Explicitly define for clarity
        };
        ...
        const slOrder = {
            ...
            size: mainOrder.size,
            side,
            // 'order_type' defines what happens when the stop price is hit.
            // A 'market_order' creates a standard stop-loss (a.k.a. stop-market).
