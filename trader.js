// trader.js
// Final, State-Aware Delta Exchange Trading Bot with Position Control & Cooldown
// Version 5.0.0
...
const config = {
  ...
  priceThreshold: parseFloat(process.env.PRICE_THRESHOLD || '3.00'),
...
class DeltaExchangeClient {
  constructor(apiKey, apiSecret, baseUrl) {
    ...
    this.axios = axios.create({ baseURL: baseUrl, timeout: 10000, headers: { 'Content-Type': 'application/json', 'User-Agent': 'Bybit-Delta-Trading-Bot/5.0.0' } });
  }
