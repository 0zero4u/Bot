...
// Version 7.0.1 - Added error handling to the local signal server to fix reconnect loop.
...
class TradingBot {
    ...
    // --- Core Methods ---
    async start() {
        this.logger.info('--- Bot Initializing (v7.0.1) ---');
    ...
    setupHttpServer() {
        ...
        httpServer.on('connection', ws => {
            ...
            // --- FIX --- Added the missing error handler
