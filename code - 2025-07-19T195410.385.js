...
// Version 7.0.2 - Corrected WebSocket authentication payload structure to match official API documentation.
...
class TradingBot {
    ...
    // --- Core Methods ---
    async start() {
        this.logger.info('--- Bot Initializing (v7.0.2) ---');
    ...
    authenticateWebSocket() {
        ...
        // --- FIX --- Correctly nest the authentication credentials inside a 'payload' object
        const authMessage = {
            type: 'auth',
            payload: {
