// trader.js
// Version 9.2.1 - Updated for Trailing Stop Strategy
// Replaced adverseMovementThreshold with momentumReversalThreshold for clarity.
...
class TradingBot {
    ...
    async start() {
        this.logger.info(`--- Bot Initializing (v9.2.1) ---`);
